...
public class ErpChartsService {
	...
	// 차트.자산 //
    public Map<String, BigDecimal> getAssetRatioData() {
        List<Object[]> results = assetRepository.findAssetRatioData();
        Map<String, BigDecimal> assetRatioData = new HashMap<>();

        for (Object[] row : results) {
            String name = (String) row[0];
            BigDecimal amount = (BigDecimal) row[1];
            assetRatioData.put(name, amount);
        }
