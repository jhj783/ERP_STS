...
public class FinancialStatementService {
	...
	public BigDecimal getCashFlowFromInvestmentActivities(LocalDateTime sDate, LocalDateTime eDate) {
		List<String> exclusionNames = Arrays.asList("예치금", "현금", "법인차량");

		BigDecimal cashFlowFromInvestmentActivities = assetLiabilityLogRepository.findCashFlow(exclusionNames, sDate,
				eDate);

		return cashFlowFromInvestmentActivities != null ? cashFlowFromInvestmentActivities : BigDecimal.ZERO;
	}
